        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if (data.success) {
                    ...
                    $('#btn-box').html('<a onclick="window.parent.NProgress.start()" href="homework/upload.html?hid='+homework.id+'&course='+homework.course+'&title='+homework.title+'&format='+homework.format+'" class="layui-btn layui-layout-right"><i class="layui-icon">&#xe681;</i>去提交</a>')
                }
            },
            error:function () {
